...
Локальный кеш нужен чтобы иметь возможность понимать, когда данные по продуктам изменились и нужно генерировать событие в другие системы. Если данные по продуту не изменились - события отправлять не нужно.
